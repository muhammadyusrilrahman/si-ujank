...
@section('card-tools')
    <a href="{{ route('tpps.index', array_filter(['type' => $selectedType ?? request('type'), 'tahun' => $selectedYear ?? request('tahun'), 'bulan' => $selectedMonth ?? request('bulan')])) }}" class="btn btn-secondary btn-sm">
