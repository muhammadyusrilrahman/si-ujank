...
@section('card-body')
    <form method="GET" action="{{ route('tpps.ebupot.index') }}" class="row align-items-end mb-4">
        ...
        <div class="col-md-3 mb-3 d-flex align-items-end">
            ...
            <a href="{{ route('tpps.ebupot.index') }}" class="btn btn-outline-secondary flex-fill">
                Atur Ulang
            </a>
        </div>
    </form>
    ...
    @if ($reports->isEmpty())
        <div class="alert alert-info mb-0">
            Belum ada arsip e-Bupot TPP untuk filter yang dipilih.
        </div>
    @else
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('tpps.ebupot.download', ['report' => $report->id, 'format' => 'xlsx']) }}" class="btn btn-outline-primary">
                                        <i class="fas fa-file-excel"></i>
                                    </a>
                                    <a href="{{ route('tpps.ebupot.download', ['report' => $report->id, 'format' => 'xml']) }}" class="btn btn-outline-secondary">
